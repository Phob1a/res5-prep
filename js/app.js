...
const views = { mock: renderMock, flashcards: renderFlashcards, practice: renderPractice, review: renderReview, import: renderImport };
const ctx = { content: { questions: [], flashcards: [] } };
