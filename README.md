...
- **SCI原题**:独立题源,收录 300 道从 SCI eBook/Mock 资源提取的原题;按 Part 与知识点排列,直接显示英文原题、中文学习辅助翻译、选项、正确答案、考点和易错点。
- **SCI Mock / SCI错题**:仅使用 SCI 原题按 Part I / Part II 独立考试,交卷后逐题回顾并把错题写入单独的 SCI 错题本。
